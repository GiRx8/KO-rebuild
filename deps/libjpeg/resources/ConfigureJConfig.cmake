...
if(NOT HAVE_STRING_H AND HAVE_STRINGS_H)
  set(DETECTED_NEED_BSD_STRINGS true)
else()
  set(DETECTED_NEED_BSD_STRINGS false)
endif()

set(NEED_BSD_STRINGS ${DETECTED_NEED_BSD_STRINGS} CACHE BOOL "Use BSD <strings.h>. Use only if system lacks ANSI/SysV <strings.h>")
...
check_c_source_compiles("
  #include <stddef.h>
	...
	int main(void)
	{
		/* Fails if size_t is NOT defined by ANSI headers */
		size_t x = 0;
		(void)x;
		return 0;
	}
" HAVE_SIZE_T_IN_ANSI_HEADERS)
...
check_c_source_compiles("
	...
	int main(void)
	{
		/* Fails if size_t is NOT defined here either */
		size_t x = 0;
		(void)x;
		return 0;
	}
" HAVE_SIZE_T_IN_SYS_TYPES_H)

if(NOT HAVE_SIZE_T_IN_ANSI_HEADERS AND HAVE_SIZE_T_IN_SYS_TYPES_H)
  set(DETECTED_NEED_SYS_TYPES_H true)
else()
  set(DETECTED_NEED_SYS_TYPES_H false)
endif()

# Define this if your system does not provide typedef size_t in any of the
# ANSI-standard places (stddef.h, stdlib.h, or stdio.h), but places it in
# <sys/types.h> instead.
set(NEED_SYS_TYPES_H ${DETECTED_NEED_SYS_TYPES_H} CACHE BOOL "size_t defined in <sys/types.h>")
...
check_c_source_compiles("
  int main(void)
  {
      /* If >> on negative signed int is logical, the array compiles */
      typedef char shift_is_unsigned[((-1 >> 1) > 0) ? 1 : -1];
      return 0;
  }
