...
public:
	...
	void WebRegisterHotkey(__IconItemSkill* pItem, int iOrder);
	void WebRegisterHotkeyByID(int skillId, int iOrder);
	void WebMoveHotkey(int fromIndex, int toIndex);
	void WebClearHotkey(int index);
};
