...
public:
	...
	void RenderTooltipAndDestructionDialog();
	...
	bool WebRClickItem(bool bSlot, int iOrder);
	bool WebMoveItem(bool bSrcSlot, int iSrcOrder, bool bDstSlot, int iDstOrder);
	bool WebDestroyItem(bool bSlot, int iOrder);
	...
	void WebShowItemTooltip(bool bSlot, int order);
	void WebHideItemTooltip();
